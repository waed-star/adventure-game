...
class Application():
    ...
    def welcome(self):
        ...
        self.characterError = True
        self.path3 = 0
        playsound('./assets/audio/music.mp3', block=False)
...
#-------------------------------------------------------------- The story begins here -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    def swim2(self):
        ...
        if int in odd:
            playsound('./assets/audio/laugh.mp3', block=False)
...
#----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    def dice(self , scare):
        ...
        if int in odd:
            playsound('./assets/audio/winSound.mp3', block=False)
...
try:
    ...
    one = PhotoImage(file = "./assets/1.png")
    two = PhotoImage(file = "./assets/2.png")
    three = PhotoImage(file = "./assets/3.png")
    four = PhotoImage(file = "./assets/4.png")
    five = PhotoImage(file = "./assets/5.png")
    six = PhotoImage(file = "./assets/6.png")
    seven = PhotoImage(file = "./assets/7.png")
    eight = PhotoImage(file = "./assets/8.png")
    nine = PhotoImage(file = "./assets/9.png")
    ten = PhotoImage(file = "./assets/10.png")
    eleven = PhotoImage(file = "./assets/11.png")
    twelve = PhotoImage(file = "./assets/graveyard.png")
    thirteen = PhotoImage(file = "./assets/13.png")
    forteen = PhotoImage(file = "./assets/14.png")
    fifteen = PhotoImage(file = "./assets/15.png")
    sixteen = PhotoImage(file = "./assets/16.png")
    seventeen = PhotoImage(file = "./assets/17.png")
    eighteen = PhotoImage(file = "./assets/18.png")
    nineteen = PhotoImage(file = "./assets/19.png")
    twenty = PhotoImage(file = "./assets/20.png")
    twentyOne = PhotoImage(file = "./assets/21.png")
    twentyTwo = PhotoImage(file = "./assets/22.png")
    twentyThree = PhotoImage(file = "./assets/23.png")
    twentyFour = PhotoImage(file = "./assets/24.png")
    twentyFive = PhotoImage(file = "./assets/25.png")
    twentySix = PhotoImage(file = "./assets/26.png")
    twentySeven = PhotoImage(file = "./assets/27.png")
    twentyEight = PhotoImage(file = "./assets/28.png")
    twentyNine = PhotoImage(file = "./assets/29.png")
    thirty = PhotoImage(file = "./assets/30.png")
    thirtyOne = PhotoImage(file = "./assets/31.png")
    thirtyTwo = PhotoImage(file = "./assets/32.png")
    thirtyThree = PhotoImage(file = "./assets/33.png")
    rip = PhotoImage(file = "./assets/rip.png")
    character = PhotoImage(file = "./assets/sprite.png")
    torch = PhotoImage(file = "./assets/torch.png")
    phoneImg = PhotoImage(file = "./assets/phone.png")
    umbrellaImg = PhotoImage(file = "./assets/umbrella.png")
    fish = PhotoImage(file = "./assets/fish.png")
    shovelImg = PhotoImage(file = "./assets/shovel.png")
    kniveImg = PhotoImage(file = "./assets/knive.png")
    shotgunImg = PhotoImage(file = "./assets/shotgunImg.png")
    gameOver = PhotoImage(file = "./assets/gameover.png")
    win = PhotoImage(file = "./assets/win.png")
    houseImg = PhotoImage(file = "./assets/house.png")
    male = PhotoImage(file = "./assets/male.png")
    female = PhotoImage(file = "./assets/female.png")
    female2 = PhotoImage(file = "./assets/sprite1.png")
    exampleImg = PhotoImage(file = "./assets/example.png")
